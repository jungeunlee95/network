...
//			consoleLog("reveiced :" + request );
			...
			} else { // 그 외 http Method는 무시 - POST, PUT, DELETE, HEAD(body없이 보낼 때), OPTION,
						// CONNECT(프록시) ...etc
				/*
				 * Header 부분 체울 내용 <응답예시> HTTP/1.1 400 File Not Found\r\n // 윈도우는 \n만 씀
				 * Content-Type:text/html; charset=utf-8/r/n \r\n HTML 에러
				 * 문서(./webapp/error/400.html)
				 */
...
//			os.write( "<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 시작할 준비가 된 것입니다.</h1>".getBytes( "UTF-8" ) );
	...
	public void responseStaticResource(OutputStream os, String url, String protocol) throws IOException {
		...
		if (file.exists() == false) {
			/*
			 * Header 부분 체울 내용 <응답예시> HTTP/1.1 404 File Not Found\r\n // 윈도우는 \n만 씀
			 * Content-Type:text/html; charset=utf-8/r/n \r\n HTML 에러
